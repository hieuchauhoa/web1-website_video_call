...
window.Element &&
    ...
    (function() {
        for (
            var r = 0, e = ["ms", "moz", "webkit", "o"], t = 0; t < e.length && !window.requestAnimationFrame;
            ++t
        )
                ...
                (M.animateScroll = function(i, c, e) {
                    ...
                    if (u || t) {
                        ...
                        0 === q.pageYOffset && q.scrollTo(0, 0),
                            ...
                            (history.pushState &&
                                h.updateURL &&
                                history.pushState({ smoothScroll: JSON.stringify(h), anchor: f.id },
                                    document.title,
